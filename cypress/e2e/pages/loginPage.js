...
class LoginPage {
    ...
    loginHeader() {
        return cy.get(select_header_login)
    }

    errorMessage() {
        return cy.get(select_error_message)
    }

    errorMessageUsername() {
        return cy.get(select_error_input_username)
    }

    errorMessagePassword() {
        return cy.get(select_error_input_password)
    }
